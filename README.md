...
Current status: **Phase 1 (skeleton)** — username login, shared lobby, chat, state
persistence, stats scaffolding. Game engine itself is the next phase.

See `/Users/twagg/.claude/plans/cosmic-doodling-kettle.md` for the full scoping plan.
...
- `data/board.json` — **not yet authored**; needs a board image
